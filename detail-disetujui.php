                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"> <a href="user_approval.php">Approval</a></li>
                ...
                ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <object data="database/file-pb/<?php echo $bis['proposal_bisnis']?>" width="100%" height="500px" 
                                style="border-radius:10px; box-shadow: 1px 3px 10px #85CDFD;"></object>
                        </div>
                        <div class="card-body">
                            <h1 class="card-title">Cash Flow</h1>
                            <object data="database/file-cf/<?php echo $bis['cash_flow']?>" width="100%" height="500px" 
                                style="border-radius:10px; box-shadow: 1px 3px 10px #85CDFD;"></object>
