                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="database/insert_layanan.php" method="post" class="form form-vertical">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <label for="target-id-icon">Nama Layanan</label>
                                                            <div class="position-relative">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <label for="target-id-icon">Latitude</label>
                                                            <div class="position-relative">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <label for="target-id-icon">Longitude</label>
                                                            <div class="position-relative">
